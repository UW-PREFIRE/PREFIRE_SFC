...
cfg_str1="ATRACK_IDXRANGE_0BASED_INCLUSIVE:5800:5900,${input_dir}/PREFIRE_SAT1_1B-RAD_R01_P00_20241007075724_01877.nc||${input_dir}/PREFIRE_SAT1_AUX-MET_R01_P00_20241007075724_01877.nc||${input_dir}/PREFIRE_SAT1_2B-MSK_R01_P00_20241007075724_01877.nc";
cfg_str2="ATRACK_IDXRANGE_0BASED_INCLUSIVE:6000:6100,${input_dir}/PREFIRE_SAT2_1B-RAD_R01_P00_20241007071543_02040.nc||${input_dir}/PREFIRE_SAT2_AUX-MET_R01_P00_20241007071543_02040.nc||${input_dir}/PREFIRE_SAT2_2B-MSK_R01_P00_20241007071543_02040.nc";
...
# Processing mode #1: Create part of a 2B-SFC granule using OE method
OUTPUT_DIR=${output_dir_base}/m1;
PROC_MODE=1;
